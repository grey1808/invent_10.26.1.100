...
/* @var $searchModel app\modules\admin\models\TechGroupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Группы техники';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="tech-group-index">
...
//            'id',
            ...
            [
                ...
                'value'=>function($data){
                    return $data -> characteristics->name ? $data->characteristics->name : 'Не заданно';
                }
            ],
            'comment',
