...
class UserController extends AppAdminController
{
    ...
    {
        Yii::$app->getView()->params['title'] = '<i class="fa fa-list" aria-hidden="true"></i> Пользователя: список пользователей';
    ...
    {
        Yii::$app->getView()->params['title'] = '<i class="fa fa-search" aria-hidden="true"></i> Просмотр пользователя';
    ...
    {
        $model = new User();
        Yii::$app->getView()->params['title'] = '<i class="fa fa-plus-square" aria-hidden="true"></i>Добавить пользователя';
